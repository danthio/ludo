...
def error_():
	...
	print(dice_1_st,dice_2_st,dice_3_st,dice_4_st)

	root.after(1000,error_)
...
def sel_game_mode():
	...
	can.create_arc(wd/2-100,ht/2-30, wd/2-100+30,ht/2,style="arc",start=90,extent=180,outline="#999999",width=1)
	can.create_arc(wd/2+100-30,ht/2-30,wd/2+100,ht/2,style="arc",start=270,extent=180,outline="#999999",width=1)


	can.create_line(wd/2-100+15,ht/2-30,  wd/2+100-15,ht/2-30,fill="#999999",width=1)
	can.create_line(wd/2-100+15,ht/2,  wd/2+100-15,ht/2,fill="#999999",width=1)



	can.create_arc(wd/2-100,ht/2-30+60, wd/2-100+30,ht/2+60,style="arc",start=90,extent=180,outline="#999999",width=1)
	can.create_arc(wd/2+100-30,ht/2-30+60,wd/2+100,ht/2+60,style="arc",start=270,extent=180,outline="#999999",width=1)


	can.create_line(wd/2-100+15,ht/2-30+60,  wd/2+100-15,ht/2-30+60,fill="#999999",width=1)
	can.create_line(wd/2-100+15,ht/2+60,  wd/2+100-15,ht/2+60,fill="#999999",width=1)
...
def sel_col():
	...
	for _ in range(4):
		...
		can.create_oval(x_,ht/2-50, x_+100,ht/2+50,outline="#999999")
	...
	can.create_arc(wd/2-100,ht-50-30, wd/2-100+30,ht-50,start=90,extent=180,style="arc",outline="#999999")
	can.create_arc(wd/2+100-30,ht-50-30, wd/2+100,ht-50,start=270,extent=180,style="arc",outline="#999999")


	can.create_line(wd/2-100+15,ht-50-30, wd/2+100-15,ht-50-30,fill="#999999") 
	can.create_line(wd/2-100+15,ht-50, wd/2+100-15,ht-50,fill="#999999")
